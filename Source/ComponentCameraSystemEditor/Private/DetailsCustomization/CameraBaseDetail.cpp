	...
	if (IsValid(Camera))
	{
		...
		if (Blueprint)
		{
...

			{
				...
				UECameraSettingsComponent* SourceComponent = Camera->GetComponentByClass<UECameraSettingsComponent>();
				UECameraSettingsComponent* TargetComponent = CDO->GetComponentByClass<UECameraSettingsComponent>();
