...
UEArchVizCameraComponent::UEArchVizCameraComponent(const FObjectInitializer& ObjectInitializer)
{
...
void UEArchVizCameraComponent::GetCameraView(float DeltaTime, FMinimalViewInfo& DesiredView)
{
...
#if WITH_EDITOR
void UEArchVizCameraComponent::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
