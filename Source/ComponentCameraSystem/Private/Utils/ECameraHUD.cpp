		...
		if (ActiveCamera && ActiveCamera->GetSettingsComponent()->IsActive())
		{
			...
			if (FollowComponent)
			{
				...
				if (FollowComponent->IsA<UScreenFollow>())
				{
					...
					FVector2D ScreenOffset = ScreenFollow->GetScreenOffset();
					FVector2D ScreenOffsetWidth = ScreenFollow->GetScreenOffsetWidth();
					FVector2D ScreenOffsetHeight = ScreenFollow->GetScreenOffsetHeight();
