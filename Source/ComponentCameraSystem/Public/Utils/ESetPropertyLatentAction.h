...
public:
	...
	void RecursivelyFindPropertyValue(FProperty* InSrcProperty, FProperty* InValueProperty, void* InSrcPtr, void* InValuePtr)
	{
		...
		else if (InSrcProperty->IsA<FFloatProperty>())
		{
			...
			PropertyValuePack.ContainerObject = Object;
			PropertyValuePack.SourceProperty = InSrcProperty;
			PropertyValuePack.SourceValue = SourceValue;
			PropertyValuePack.TargetValue = TargetValue;
			PropertyValuePack.SourceValuePtr = (FFloatProperty::TCppType*)InSrcPtr;
	...
	void ConvertAndAddPropertyValuePack(PropertyType* InSrcProperty, PropertyType* InValueProperty, void* InSrcPtr, void* InValuePtr)
	{
		...
		PropertyValuePack.SourceValue = SourceValue;
		PropertyValuePack.TargetValue = TargetValue;
		PropertyValuePack.SourceValuePtr = (typename PropertyType::TCppType*)InSrcPtr;
