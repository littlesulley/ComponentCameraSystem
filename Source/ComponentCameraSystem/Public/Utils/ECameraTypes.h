...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "ECamera|FDampParams", Meta = (EditCondition = "DampMethod == EDampMethod::Naive || DampMethod == EDampMethod::Simulate || DampMethod == EDampMethod::ContinuousNaive"))
	FVector DampTime;
