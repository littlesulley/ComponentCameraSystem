...
public:
	...
	DECLARE_FUNCTION(execSetPropertyByName)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		std::pair<FProperty*, void*>&& PropertyPtrPair = GetNestedPropertyFromObject(Object, PropertyName);
		FProperty* SrcProperty = PropertyPtrPair.first;
		void* SrcPtr = PropertyPtrPair.second;
