...
#include "DeoccluderExtension.generated.h"
...
class COMPONENTCAMERASYSTEM_API UDeoccluderExtension : public UECameraExtensionBase
{
	GENERATED_BODY()

public:
	UDeoccluderExtension();

protected:
	/** A set of parameters describing how to avoid occlusion. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "DeoccluderExtension")
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "DeoccluderExtension", meta = (ClampMin = "0.0"))
