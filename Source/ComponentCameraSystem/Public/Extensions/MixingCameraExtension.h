...
private:
	...
	FVector4 FindEigenvectorUsingPI(const FMatrix& M, const FVector4& V, const int Steps, const float Epsilon = UE_SMALL_NUMBER);
	FVector4 NormalizeVector4(const FVector4& V, float Tolerance = UE_SMALL_NUMBER);
};
